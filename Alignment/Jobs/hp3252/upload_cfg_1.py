...
process.AlignmentProducer.algoConfig.IOVrange=cms.vuint32(361579)
...
process.source = cms.Source("EmptySource", firstRun = cms.untracked.uint32(361579)) 
...
process.PoolDBOutputService.connect ='sqlite_file:/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN2/HipPy/lkang/hp361579/Jobs/hp3252/alignments.db'
process.AlignmentProducer.algoConfig.outpath = '/afs/cern.ch/cms/CAF/CMSALCA/ALCA_TRACKERALIGN2/HipPy/lkang/hp361579/Jobs/hp3252/'
